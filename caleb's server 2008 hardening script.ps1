...
function GPTool{
    ...
    X_RDP = "Computer Configuration ù Administrative Templates ù Windows Components ù Remote Desktop Services ù Remote Desktop Session Host ù Connections.
...
function disableRDP{
    ...
    Set-ItemProperty -Path "HKLM:\System\CurrentControlSet\Control\Terminal Server" -Name "fDenyTSConnections" ùValue 1 ùForce
