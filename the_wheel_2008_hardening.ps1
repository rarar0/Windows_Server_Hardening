<#--------------------------------------------------------------------------------------------------------------
    'The Wheel' - Server 2008(R2, 32, 64-bit) Hardening
        Author: Caleb Anderson, calebtree8163.ccdc@gmail.com, Metropolitan State University - CCDC Team 2019-20

    Mmuch credit to my CCDC team this year and years past: 
    Skyler Jensen - hardening checklists and resources
    Kevin Day - hardening checklists
    Kyle Henderson (from last year) - introduction to AD password change loop, and hardening checklists
    Website resources (many others):
    https://docs.microsoft.com (en-us/archive/blogs/besidethepoint/decrypt-secure-strings-in-powershell) - good read on Marshaling and BSTR with PS secure strings
    ...
    - First version published to 'CDC resources' last updated 1/11/2020

    To do list:
        - ensure all changes have relevant output and/or reversability
        - add more error handeling
        - add enhanced auditing
        - add malware discovery
---------------------------------------------------------------------------------------------------------------#>
